        ...
        return(
            <footer className='footer'>
                <ul>
                    ...
                    <li className={props.footer === 1 ?'footer_item_concern_selected' : 'footer_item_concern'} onClick={this.changeStatus.bind(this,1)}><Link to="/discover"><i></i>图书</Link></li>
                    <li className={props.footer === 2 ? 'footer_item_concern_selected' : 'footer_item_concern'} onClick={this.changeStatus.bind(this,2)}><Link to="/user"><i></i>发现</Link></li>
